...
<body>
  ...
  <div class="col">
    <div class="card h-100">
      ...
      <div class="card-body">
		...
		<ul><li>Length – 150cm | Width – 130cm | Height – 110cm</li>
  ...
  <div class="col">
    ...
    <ul><li>KCF 001 – Length – 216cm | Width – 108cm | Height – 76.5cm</li>
  ...
  <div class="col">
    ...
    <ul><li>Length – 406cm | Width – 244cm | Height – 106cm</li>
     </ul><br>
...
<footer style="background-color: #282c34; color: #f1f1f1; padding: 20px 0; text-align: center;">
  <div style="max-width: 1000px; margin: 0 auto; display: flex; flex-wrap: wrap; justify-content: space-between; align-items: center; padding: 0 20px;">
    <!-- Brand and Tagline -->
    <div style="margin-bottom: 10px;">
      <h3 style="margin: 0; font-size: 18px; color: #61dafb;">Home Heaven Furniture</h3>
      <p style="margin: 5px 0; font-size: 14px;"><i>Your Home,Your Style</i></p>
    </div>
    <!-- Footer Links -->
    
    <!-- Social Media Icons -->
    <div style="margin-bottom: 10px;">
      <a href="https://facebook.com" target="_blank" style="text-decoration: none; margin: 0 5px;">
        <img src="https://cdn-icons-png.flaticon.com/512/733/733547.png" alt="Facebook" style="width: 24px;">
      </a>
      <a href="https://twitter.com" target="_blank" style="text-decoration: none; margin: 0 5px;">
        <img src="https://cdn-icons-png.flaticon.com/512/733/733579.png" alt="Twitter" style="width: 24px;">
      </a>
      <a href="https://linkedin.com" target="_blank" style="text-decoration: none; margin: 0 5px;">
        <img src="https://cdn-icons-png.flaticon.com/512/733/733561.png" alt="LinkedIn" style="width: 24px;">
      </a>
    </div>
  </div>
  <p style="margin: 10px 0; font-size: 12px;">&copy; Home Heaven Furniture.All Rights Reserved</p>
</footer>
